...
export function CreateAdModal() {
  ...
  async function handleCreateAd(event: FormEvent) {
    ...
    console.log(newAds);
    try {
      await axios.post(`http://localhost:3333/games/${data.game}/ads`, newAds);
      alert("Anuncio criado com sucesso!");
    } catch (err) {
      console.log("erro");
      console.log(err);
      alert("erro ao inserir Anuncio");
    }
  }
          ...
          <label className="mt-2 flex items-center gap-2 text-sm">
            <Checkbox.Root
              ...
              onCheckedChange={(checked) => {
                checked === true ? setUseVoice(true) : setUseVoice(false);
              }}
